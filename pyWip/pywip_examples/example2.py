...
# Plot data from 'data-ex2.dat' with x data = column 1, y data = col. 2,
# and symbol data for each point from column 3
plot(1,2,'data-ex2.dat',style=3,limits=[0,10,0,20])
plot(1,2,'data-ex2.dat',style='-') # Connect the data points with a line
